...
"""Ecommerce Env Environment Client."""
...
class EcommerceEnv(
    ...
    """
    Client for the Ecommerce Env Environment.
    ...
    Example:
        ...
        >>> with EcommerceEnv(base_url="http://localhost:8000") as client:
        ...     result = client.reset()
        ...     print(result.observation.echoed_message)
        ...
        ...     result = client.step(EcommerceAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = EcommerceEnv.from_docker_image("ecommerce_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(EcommerceAction(message="Test"))
        ... finally:
        ...     client.close()
    """
    ...
    def _parse_result(self, payload: Dict) -> StepResult[EcommerceObservation]:
        ...
        Returns:
            StepResult with EcommerceObservation
        """
